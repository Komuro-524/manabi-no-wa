...
| | 起動 | 仕事 |
|---|---|---|
| 🎙️ **A 記録係** | ライブが終わったら | 知見カードを切り出し タグを貼る |
| 🎪 **B 幹事** | 1日1回 自分で起きる | **立てるか決める** → 打診 → 日程調整 → 予約 |
| 🔍 **C 自己分析係** | 本人がボタンを押したら | 作業中の画面から タグ候補を出す |
...
「全部AIがやります」ではありません。**人の介在点を意図的に3か所に絞って設計しています。**

| | ゲート | 誰が |
|---|---|---|
| 1 | 🚪 **相談役への打診** に答える | 打診された本人 |
| 2 | 🏷️ **タグ辞書への昇格**を承認する | 管理者 |
| 3 | 🚨 **例外エスカレーション** を受ける | 管理者 |
...
- 自己分析係は**画像を保存しません**。DBに画像を持つ列自体がありません
